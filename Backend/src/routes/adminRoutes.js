...
import {getUserData, getSingleUserById, getAllUsers, getAllAdmins, uploadUserImage, uploadUserSignature, getFinanceOverview} from "../controllers/adminController.js";
...
//financeaOverview
router.get('/finance-overview', authMiddleware, isAdmin, getFinanceOverview);
